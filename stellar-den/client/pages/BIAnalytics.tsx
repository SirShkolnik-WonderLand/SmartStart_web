...
const BIAnalytics: React.FC = () => {
  ...
  const pageUrl = 'https://alicesolutionsgroup.com/bi-analytics';
  const pageTitle = 'Business Intelligence & Analytics Toronto | BI Analytics Services | AliceSolutionsGroup';
  const pageDescription = 'Business intelligence and analytics services for Toronto businesses. Real-time dashboards, predictive analytics, data integration. Privacy-compliant analytics solutions. Serving GTA and Ontario.';
  const services = [
    {
      icon: BarChart3,
  ...
  // BI Analytics Service Schema
  const biAnalyticsSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Business Intelligence & Analytics",
    "name": "BI & Analytics Services",
    "description": "Business intelligence and analytics services for Toronto businesses",
    "provider": {
      "@type": "Organization",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="business intelligence Toronto, BI analytics GTA, data analytics Ontario, predictive analytics Toronto, data dashboards Toronto, BI consulting Canada" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(biAnalyticsSchema)}
        </script>
      </Helmet>
      <StructuredData 
        type="page"
        ...
        breadcrumbs={[
          ...
          { name: "BI & Analytics", url: "/bi-analytics" }
        ]}
      />
