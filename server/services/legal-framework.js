...
class LegalFrameworkService {
    constructor() {
        ...
        this.rbacDocumentRequirements = {
            'GUEST': [],
            'MEMBER': ['PPA', 'E_SIGNATURE_CONSENT', 'PRIVACY_NOTICE', 'MUTUAL_NDA', 'SECURITY_ACKNOWLEDGMENT', 'PAYMENT_TERMS'],
            'SUBSCRIBER': ['PTSA', 'SOBA'],
            'SEAT_HOLDER': ['SOBA', 'SECURITY_ACKNOWLEDGMENT'],
            'VENTURE_OWNER': ['IDEA_SUBMISSION', 'PER_PROJECT_NDA'],
            'VENTURE_PARTICIPANT': ['PCA', 'PER_PROJECT_NDA', 'IP_ASSIGNMENT'],
            'EXTERNAL_PARTNER': ['JDA', 'MUTUAL_NDA', 'PER_PROJECT_NDA'],
            ...
            'ANALYTICS_ACCESS': ['DATA_ANALYTICS'],
            'API_ACCESS': ['API_USAGE'],
            'DOCUMENT_ADMIN': ['DOCUMENT_MANAGEMENT'],
            'INCIDENT_RESPONDER': ['INCIDENT_RESPONSE'],
            'AUDIT_PARTICIPANT': ['AUDIT_COOPERATION']
        };
