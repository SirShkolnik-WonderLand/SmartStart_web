...
class LegalFrameworkService {
    constructor() {
        ...
        this.rbacDocumentRequirements = {
            ...
            'SEAT_HOLDER': ['SOBA_UPDATE', 'TEAM_COLLABORATION'],
            'VENTURE_OWNER': ['ISEA', 'VOA', 'PPNA'],
            'VENTURE_PARTICIPANT': ['PCA', 'PPNA', 'IAA'],
            'EXTERNAL_PARTNER': ['JDA', 'MUTUAL_NDA', 'PPNA', 'DPA'],
            'CONFIDENTIAL_ACCESS': ['ST1A', 'PPNA_TIER1'],
            'RESTRICTED_ACCESS': ['ST2A', 'ESA', 'PPNA_TIER2'],
            'HIGHLY_RESTRICTED_ACCESS': ['ST3A', 'CJIA', 'ESA', 'PPNA_TIER3', 'SCV'],
            'BILLING_ADMIN': ['BAA', 'ECA', 'ATA'],
            'SECURITY_ADMIN': ['SAA', 'IRA', 'ECA', 'LCA'],
            'LEGAL_ADMIN': ['LAA', 'ACPA', 'ECA', 'RCA'],
            'ANALYTICS_ACCESS': ['DAA', 'DATA_ANONYMIZATION', 'REPORTING_COMPLIANCE'],
            'API_ACCESS': ['APIUA', 'INTEGRATION_SECURITY', 'DATA_EXPORT'],
            'DOCUMENT_ADMIN': ['DMA', 'VERSION_CONTROL', 'RETENTION_POLICY'],
            'INCIDENT_RESPONDER': ['IRA', 'BREACH_NOTIFICATION', 'FORENSIC_INVESTIGATION'],
            'AUDIT_PARTICIPANT': ['ACA', 'DOCUMENT_PRODUCTION', 'AUDIT_CONFIDENTIALITY']
        };
