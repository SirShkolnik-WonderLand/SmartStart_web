...
This authorization enables team expansion and collaboration on the platform.`,
        ...
        console.log('🔍 Calling signDocument with:', { userId, actualDocumentId, enhancedSignatureData });
        const signature = await legalDocumentService.signDocument(userId, actualDocumentId, enhancedSignatureData);
