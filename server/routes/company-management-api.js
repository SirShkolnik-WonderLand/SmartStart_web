...
router.post('/create-tables', async (req, res) => {
  try {
    ...
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "Company_sector_idx" ON "Company"("sector");`;
    ...
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "Company_region_idx" ON "Company"("region");`;
    ...
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "CompanyTag_usageCount_idx" ON "CompanyTag"("usageCount");`;
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "CompanyTag_confidence_idx" ON "CompanyTag"("confidence");`;

    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "CompanyHierarchy_parentCompanyId_idx" ON "CompanyHierarchy"("parentCompanyId");`;
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "CompanyHierarchy_childCompanyId_idx" ON "CompanyHierarchy"("childCompanyId");`;
    ...
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "CompanyDocument_isPublic_idx" ON "CompanyDocument"("isPublic");`;
    await prisma.$executeRaw`CREATE INDEX IF NOT EXISTS "CompanyDocument_createdAt_idx" ON "CompanyDocument"("createdAt");`;
